  ...
  return (
    <div className="min-h-screen bg-background">
      ...
      <main>
        ...
        <section id="previous-events" className="py-16 bg-muted/30">
          <div className="container mx-auto px-4">
            <h2 className="text-3xl sm:text-4xl font-bold mb-6 text-center">
              Previous <span className="bg-gradient-to-r from-primary to-secondary bg-clip-text text-transparent">Events</span>
            </h2>
            <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 gap-4">
              {[
                ...
                <div key={idx} className="w-full h-40 md:h-48 overflow-hidden rounded-lg group">
                  <img 
                    src={src} 
                    alt={`Previous event ${idx + 1}`} 
